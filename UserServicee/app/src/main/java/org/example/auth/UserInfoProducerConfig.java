...
public class UserInfoProducerConfig {
    ...
    @Bean
    public ConsumerFactory<String, UserInfoDto> userInfoConsumerFactory(){
        Map<String,Object> configprops=new HashMap<>();
        configprops.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG,bootstrapServers);
        configprops.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        configprops.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG,org.example.deserializer.UserInfoDeserializer.class);
